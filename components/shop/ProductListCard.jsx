...
export default function ProductListCard({ product }) {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row items-start gap-4 border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md bg-white transition-all">
        {/* Image Section */}
        ...
        <div className="flex-1 flex flex-col justify-between space-y-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#724b00] hover:bg-[#5e3d00] text-white rounded-md transition text-sm w-full sm:w-auto"
            >
