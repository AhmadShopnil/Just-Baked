...
export default function Description() {
  ...
  return (
    <div className="border rounded-md overflow-hidden">
      ...
      <div className="flex">
        <button
          className={`py-2 px-4 ${activeTab === "description" ? "bg-gray-100" : "bg-gray-50"} font-medium`}
          onClick={() => setActiveTab("description")}
        >
          DESCRIPTION
        </button>
        <button
          className={`py-2 px-4 ${activeTab === "questions" ? "bg-amber-800 text-white" : "bg-gray-50"} font-medium`}
        ...
        {activeTab === "description" ? (
          ...
          <div>
            ...
            <div className="flex items-start gap-4 mb-6">
              <div className="w-8 h-8 flex items-center justify-center bg-gray-100 rounded-full">K</div>
              ...
              <button className="bg-gray-200 text-gray-800 px-4 py-1 rounded-md" onClick={handlePostComment}>
                Post
              </button>
            </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                        <button className="hover:text-gray-700" onClick={() => handleReply(comment.id)}>
                          Reply
                        </button>
                        <span>•</span>
                        <button className="hover:text-gray-700" onClick={() => handleShare(comment.id)}>
                          Share
                        </button>
                        <span>•</span>
                      ...
                      {comment.replies.map((reply) => (
                        <div key={reply.id} className="flex gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                              <button className="hover:text-gray-700" onClick={() => handleReply(reply.id)}>
                                Reply
                              </button>
                              <span>•</span>
                              <button className="hover:text-gray-700" onClick={() => handleShare(reply.id)}>
                                Share
                              </button>
                              <span>•</span>
