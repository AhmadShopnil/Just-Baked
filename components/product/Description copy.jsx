...
export default function Description() {
  const [activeTab, setActiveTab] = useState("description"); // Default to questions tab as shown in image
        ...
        <div className="p-4">
          {activeTab === "description" ? (
            <div className="prose max-w-none ">
              ...
              <h2 className="font-semibold my-2">Product Description</h2>
              <p>
            ...
            <div>
              ...
              <div className="space-y-6">
                {comments.map((comment) => (
                  <div
                    key={comment.id}
                    className="space-y-4 border-b border-gray-100 pb-5"
                  >
                    {/* Main Comment */}
